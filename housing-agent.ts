...
interface DeterministicFilters {
  minPrice?: number;
  maxPrice?: number;
  minBedrooms?: number;
  maxBedrooms?: number;
...
class HousingAgent {
  ...
  filterListings(filters: DeterministicFilters): CleanListing[] {
  ...
  async extractFilters(query: string): Promise<DeterministicFilters> {
    const prompt = `
...
export { HousingAgent, DeterministicFilters };
