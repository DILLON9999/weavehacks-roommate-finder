...
exports.FacebookSessionManager = void 0;
...
class FacebookSessionManager {
    constructor() {
        ...
        this.sessionPath = (0, path_1.join)(process.cwd(), '.facebook-session.json');
    }
    /**
    ...
    hasValidSession() {
        try {
            ...
            const sessionData = JSON.parse((0, fs_1.readFileSync)(this.sessionPath, 'utf-8'));
    ...
    saveSession(session) {
        try {
            (0, fs_1.writeFileSync)(this.sessionPath, JSON.stringify(session, null, 2));
    ...
    clearSession() {
        try {
            if ((0, fs_1.existsSync)(this.sessionPath)) {
                (0, fs_1.writeFileSync)(this.sessionPath, JSON.stringify({ isValid: false }, null, 2));
     ...
     */
    async applySessionToStagehand(stagehand) {
        try {
...
exports.FacebookSessionManager = FacebookSessionManager;
